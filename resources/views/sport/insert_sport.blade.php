                        ...
                        <form id="form-sport" class="needs-validation" novalidate>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control maxchar-40" id="nama_cabor" name="name" required>
...
<script>
    $(document).ready(function () {
        $('#form-sport').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("web.sports.store") }}', // Ganti sesuai rute controller Anda
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
                    ...
                    `);
                    $('#form-sport')[0].reset();
                    $('#form-sport').removeClass('was-validated');
                },
                error: function (xhr) {
                    if (xhr.status === 422) {
